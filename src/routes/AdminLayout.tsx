...
import {
  ...
  UtensilsCrossed, CreditCard, BarChart3, LogOut, ChevronRight, Armchair, UserCog, Image,
} from 'lucide-react'
...
const navLinks = [
  ...
  { to: ROUTES.ADMIN.EMPLOYEES, label: 'Funcionarios', icon: UserCog },
  ...
  { to: ROUTES.ADMIN.IMAGES, label: 'Imagens', icon: Image },
