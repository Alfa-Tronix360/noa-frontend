...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[60vh] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 px-4 sm:px-6 lg:px-8 pb-12 max-w-7xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <p className="text-xs tracking-[0.3em] uppercase mb-3" style={{ color: '#7BB8CE' }}>A nossa história</p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <p className="text-xs tracking-[0.3em] uppercase mb-4" style={{ color: '#C9A96E' }}>Quem somos</p>
      ...
      <section className="bg-surface/50 border-y border-border/40 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-12">
            <p className="text-xs tracking-[0.3em] uppercase mb-3" style={{ color: '#C9A96E' }}>Os nossos pilares</p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-12">
          <p className="text-xs tracking-[0.3em] uppercase mb-3" style={{ color: '#C9A96E' }}>A nossa jornada</p>
          ...
          {timeline.map((item, i) => (
            ...
            >
              <div className="relative z-10 w-16 h-16 rounded-full border-2 flex flex-col items-center justify-center flex-shrink-0"
                style={{ borderColor: '#7BB8CE', backgroundColor: '#181818' }}>
                <span className="font-display text-sm font-bold" style={{ color: '#7BB8CE' }}>{item.year}</span>
              </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="mb-8">
          <p className="text-xs tracking-[0.3em] uppercase mb-2" style={{ color: '#C9A96E' }}>O nosso espaço</p>
